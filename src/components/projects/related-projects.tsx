      ...
      {projects.map((project, i) => (
        <ScrollReveal key={project.slug} delay={i * 0.08}>
          <Link
            ...
            className="group block h-full rounded-xl border border-border bg-card overflow-hidden transition-all duration-200 hover:border-primary/30 hover:shadow-md"
          >
